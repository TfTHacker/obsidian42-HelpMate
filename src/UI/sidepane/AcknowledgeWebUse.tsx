...
const AcknowledgeWebUse: FunctionComponent<AcknowledgeProps> = ({
  ...
  return (
    <div class="hm-acknowledge-message">
      <p>
        {' '}
        HelpMate displays the help content from websites in the sidepane. Please keep in
        mind that this help content is coming from the web and you are responsible to
        verify that the sites are safe.
      </p>
      <p>Please check the Acknowledge checkbox to proceed.</p>
      <input type="checkbox" checked={isChecked} onChange={handleCheckboxChange} />
      <label>Acknowledge this message</label>
      <br />
      <br />
