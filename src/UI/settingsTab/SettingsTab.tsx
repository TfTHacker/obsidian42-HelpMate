...
export class HelpMateSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.addText((text) =>
				text
					.setValue(this.plugin.settings.obsidianHelpUrl)
					.onChange(async (value) => {
						const newValue =
							value.trim() === "" ? DEFAULT_SETTINGS.obsidianHelpUrl : value;
						this.plugin.settings.obsidianHelpUrl = newValue;
						await this.plugin.saveSettings();
					}),
			);
		...
		new Setting(containerEl)
			...
			.addText((text) =>
				text
					.setValue(this.plugin.settings.obsidianDevHelpUrl)
					.onChange(async (value) => {
						const newValue =
							value.trim() === "" ? DEFAULT_SETTINGS.obsidianDevHelpUrl : value;
						this.plugin.settings.obsidianDevHelpUrl = newValue;
						await this.plugin.saveSettings();
					}),
			);
		...
		helpUrlList
			.setValue(this.plugin.settings.userResources)
			.onChange(async (value) => {
